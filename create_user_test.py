...
# Функция для негативной проверки при отсутствии или незаполнении параметра
...
# Параметр fisrtName не передан в теле запроса
...
# Параметр fisrtName передан числом вместо строки
